...
public class WatermarkServlet extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
    {
        /*L'appel de ce servlet se fait en donnant l'url de la miniature de l'image.
          Ici, on remplace le chemin du répertoire de thumbnails par le répertoire 
        ...
        {File file = new File(path);
            ...
            /* Si le client n'a pas "payé", on ajoute le watermark. Sinon,
            ...
            //   on écrit directement les bits de l'image dans la réponse, 
